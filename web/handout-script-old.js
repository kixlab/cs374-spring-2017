...
var AUTHORS = 'This work is licensed under CC BY-SA 4.0.';
var HOME = 'kixlab.org/courses/hci/';
...
function setup() {
  ...
  $('.lecture').first().prepend($('<h1>').text(title).addClass('lecture-info col-sm-6 col-sm-offset-4'));
  // bootstrappiness
  $('.markdown, .with-content').addClass('col-sm-6 col-sm-offset-4');
